...
namespace AlanJuden.MvcReportViewer
{
	public static class CoreHtmlHelpers
	{
		public static HtmlString RenderReportViewer(this IHtmlHelper helper, ReportViewerModel model, int? startPage = 1)
		{
			...
			sb.AppendLine($"								<a href='#' title='Find' class='btn btn-info FindTextButton'><span class='glyphicon glyphicon-search' style='padding-right: .5em;'></span>Buscar</a>");
			sb.AppendLine("							</span>");
			sb.AppendLine("						</div>");
			sb.AppendLine("						<div class='btn-group'>");
			...
			sb.AppendLine("								<li><a href='#' class='ExportCsv'>CSV (separado por coma)</a></li>");
			sb.AppendLine("								<li><a href='#' class='ExportExcelOpenXml'>Excel</a></li>");
			sb.AppendLine("								<li><a href='#' class='ExportMhtml'>MHTML (archivo web)</a></li>");
			...
			sb.AppendLine("								<li><a href='#' class='ExportXml'>XML fichero con los datos del reportes</a></li>");
			sb.AppendLine("							</ul>");
			//sb.AppendLine("						</div>");
			//sb.AppendLine("						<div class='btn-group'>");
			...
			{
				sb.AppendLine("			<div class='ReportViewerInformation'>Por Favor Llene los Campos y Ejecute el Reporte...</div>");
			}
			else
			{
