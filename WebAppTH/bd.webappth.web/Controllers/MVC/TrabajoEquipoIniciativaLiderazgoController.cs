...
namespace bd.webappth.web.Controllers.MVC
{
    public class TrabajoEquipoIniciativaLiderazgoController : Controller
    {
        ...
        public TrabajoEquipoIniciativaLiderazgoController(IApiServicio apiServicio)
        {
        ...
        public async Task<IActionResult> Create(TrabajoEquipoIniciativaLiderazgo trabajoEquipoIniciativaLiderazgo)
        {
            ...
            try
            {
                response = await apiServicio.InsertarAsync(trabajoEquipoIniciativaLiderazgo,
                                                             ...
                                                             "/api/TrabajoEquipoIniciativaLiderazgo/InsertarTrabajoEquipoIniciativaLiderazgo");
                if (response.IsSuccess)
                {
                    ...
                    var responseLog = await GuardarLogService.SaveLogEntry(new LogEntryTranfer
                    {
                        ...
                        ExceptionTrace = null,
                        Message = "Se ha creado un Trabajo Equipo Iniciativa Liderazgo",
                        UserName = "Usuario 1",
                        LogCategoryParametre = Convert.ToString(LogCategoryParameter.Create),
                        LogLevelShortName = Convert.ToString(LogLevelParameter.ADV),
                        EntityID = string.Format("{0} {1}", "Trabajo Equipo Iniciativa Liderazgo:", trabajoEquipoIniciativaLiderazgo.IdTrabajoEquipoIniciativaLiderazgo),
                    });
            ...
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppTh),
                    Message = "Creando Trabajo Equipo Iniciativa Liderazgo",
                    ExceptionTrace = ex,
                    LogCategoryParametre = Convert.ToString(LogCategoryParameter.Create),
            ...
            try
            {
                if (!string.IsNullOrEmpty(id))
                {
                    var respuesta = await apiServicio.SeleccionarAsync<Response>(id, new Uri(WebApp.BaseAddress),
                                                                  "/api/TrabajoEquipoIniciativaLiderazgo");
        ...
        public async Task<IActionResult> Edit(string id, TrabajoEquipoIniciativaLiderazgo trabajoEquipoIniciativaLiderazgo)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppTh),
                    Message = "Editando un Trabajo Equipo Iniciativa Liderazgo",
                    ExceptionTrace = ex,
                    LogCategoryParametre = Convert.ToString(LogCategoryParameter.Edit),
                    LogLevelShortName = Convert.ToString(LogLevelParameter.ERR),
                    UserName = "Usuario APP webappth"
        ...
        public async Task<IActionResult> Index()
        {
            ...
            try
            {
                lista = await apiServicio.Listar<TrabajoEquipoIniciativaLiderazgo>(new Uri(WebApp.BaseAddress)
                                                                    , "/api/TrabajoEquipoIniciativaLiderazgo/ListarTrabajoEquipoIniciativaLiderazgo");
                return View(lista);
            }
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppTh),
                    Message = "Listando Trabajo Equipo Iniciativa Liderazgo",
                    ExceptionTrace = ex,
        ...
        public async Task<IActionResult> Delete(string id)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppTh),
                    Message = "Eliminar Trabajo Equipo Iniciativa Liderazgo",
                    ExceptionTrace = ex,
                    LogCategoryParametre = Convert.ToString(LogCategoryParameter.Delete),
                    LogLevelShortName = Convert.ToString(LogLevelParameter.ERR),
                    UserName = "Usuario APP webappth"
