...
{
    public class MigracionCapacitacioneSucursalController : Controller
    {
        private IHostingEnvironment _hostingEnvironment;
        private readonly IApiServicio apiServicio;
        private readonly IUploadFileService uploadFileService;

        public MigracionCapacitacioneSucursalController(IApiServicio apiServicio, IHostingEnvironment _hostingEnvironment, IUploadFileService uploadFileService)
        {
            ...
            try
            {
                ...
                if (NombreUsuario != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(id))
                    {
                        ...
                        var envia = new GestionPlanCapacitacion { IdGestionPlanCapacitacion = Convert.ToInt32(id), NombreUsuario = NombreUsuario };
