...
namespace bd.webappth.web.Controllers.MVC
{
    public class RelacionesInternasExternasDeIndiceOcupacionalController : Controller
    {
        ...
        public async Task<IActionResult> EliminarIndiceOcupacionalRelacionesInternasExternas(int idRelacionesInternasExternas, int idIndiceOcupacional)
        {
            ...
            try
            {
                ...
                var response = await apiServicio.EliminarAsync(relacionesInternasExternasIndiceOcupacional, new Uri(WebApp.BaseAddress)
                                                               , "/api/RelacionesInternasExternas/EliminarIndiceOcupacionalRelacionesInternasExternas");
                if (response.IsSuccess)
                {
                    await GuardarLogService.SaveLogEntry(new LogEntryTranfer
                    {
