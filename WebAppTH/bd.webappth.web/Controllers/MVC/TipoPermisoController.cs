...
namespace bd.webappth.web.Controllers.MVC
{
    public class TipoPermisoController : Controller
    {
        ...
        public TipoPermisoController(IApiServicio apiServicio)
        {
        ...
        public async Task<IActionResult> Create(TipoPermiso tipoPermiso)
        {
            ...
            try
            {
                response = await apiServicio.InsertarAsync(tipoPermiso,
                                                             ...
                                                             "/api/TipoPermiso/InsertarTipoPermiso");
                if (response.IsSuccess)
                {
                    ...
                    var responseLog = await GuardarLogService.SaveLogEntry(new LogEntryTranfer
                    {
                        ...
                        EntityID = string.Format("{0} {1}", "Tipo Permiso:", tipoPermiso.IdTipoPermiso),
                    });
            ...
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppTh),
                    Message = "Creando Tipo de Permiso",
                    ExceptionTrace = ex,
                    LogCategoryParametre = Convert.ToString(LogCategoryParameter.Create),
        ...
        public async Task<IActionResult> Index()
        {
            ...
            try
            {
                lista = await apiServicio.Listar<TipoPermiso>(new Uri(WebApp.BaseAddress)
                                                                    , "/api/TipoPermiso/ListarTipoPermiso");
                return View(lista);
            }
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppTh),
                    Message = "Listando tipos de permiso",
                    ExceptionTrace = ex,
