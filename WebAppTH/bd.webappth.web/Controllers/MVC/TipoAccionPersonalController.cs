...
namespace bd.webappth.web.Controllers.MVC
{
    public class TipoAccionPersonalController : Controller
    {
        ...
        public TipoAccionPersonalController(IApiServicio apiServicio)
        {
        ...
        public async Task<IActionResult> Create(TipoAccionPersonal tipoAccionPersonal)
        {
            ...
            try
            {
                response = await apiServicio.InsertarAsync(tipoAccionPersonal,
                                                             ...
                                                             "/api/TipoAccionPersonal/InsertarTipoAccionPersonal");
                if (response.IsSuccess)
                {
                    ...
                    var responseLog = await GuardarLogService.SaveLogEntry(new LogEntryTranfer
                    {
                        ...
                        EntityID = string.Format("{0} {1}", "Tipo Accion Personal:", tipoAccionPersonal.IdTipoAccionPersonal),
                    });
            ...
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppTh),
                    Message = "Creando Tipo Accion Personal",
                    ExceptionTrace = ex,
                    LogCategoryParametre = Convert.ToString(LogCategoryParameter.Create),
        ...
        public async Task<IActionResult> Edit(string id, TipoAccionPersonal tipoAccionPersonal)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppTh),
                    Message = "Editando un tipo de accion personal",
                    ExceptionTrace = ex,
                    LogCategoryParametre = Convert.ToString(LogCategoryParameter.Edit),
                    LogLevelShortName = Convert.ToString(LogLevelParameter.ERR),
                    UserName = "Usuario APP webappth"
        ...
        public async Task<IActionResult> Index()
        {
            ...
            try
            {
                lista = await apiServicio.Listar<TipoAccionPersonal>(new Uri(WebApp.BaseAddress)
                                                                    , "/api/TipoAccionPersonal/ListarTipoAccionPersonal");
                return View(lista);
            }
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppTh),
                    Message = "Listando TipoAccionPersonal",
                    ExceptionTrace = ex,
        ...
        public async Task<IActionResult> Delete(string id)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppTh),
                    Message = "Eliminar tipo accion personal",
                    ExceptionTrace = ex,
                    LogCategoryParametre = Convert.ToString(LogCategoryParameter.Delete),
                    LogLevelShortName = Convert.ToString(LogLevelParameter.ERR),
                    UserName = "Usuario APP webappth"
