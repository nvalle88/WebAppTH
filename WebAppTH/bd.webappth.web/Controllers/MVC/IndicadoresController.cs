...
namespace bd.webappth.web.Controllers.MVC
{
    public class IndicadoresController : Controller
    {
        ...
        public IndicadoresController(IApiServicio apiServicio)
        {
        ...
        public async Task<IActionResult> Edit(string id)
        {
            try
            {
                if (!string.IsNullOrEmpty(id))
                {
                    ...
                    respuesta.Resultado = JsonConvert.DeserializeObject<Indicador>(respuesta.Resultado.ToString());
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var lista = new List<Indicador>();
            try
            {
                lista = await apiServicio.Listar<Indicador>(new Uri(WebApp.BaseAddress)
                                                                    , "api/Indicadores/ListarIndicadores");
                InicializarMensaje(null);
                return View(lista);
            }
            catch (Exception ex)
