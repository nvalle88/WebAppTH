...
namespace bd.webappth.web.Controllers.MVC
{
    public class ParametrosGeneralesController : Controller
    {
        ...
        public ParametrosGeneralesController(IApiServicio apiServicio)
        {
        ...
        public async Task<IActionResult> Edit(string id)
        {
            try
            {
                if (!string.IsNullOrEmpty(id))
                {
                    ...
                    respuesta.Resultado = JsonConvert.DeserializeObject<ParametrosGenerales>(respuesta.Resultado.ToString());
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var lista = new List<ParametrosGenerales>();
            try
            {
                lista = await apiServicio.Listar<ParametrosGenerales>(new Uri(WebApp.BaseAddress)
                                                                    , "api/ParametrosGenerales/ListarParametrosGenerales");
                InicializarMensaje(null);
                return View(lista);
            }
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppTh),
                    Message = "Listando Parametros Generales",
                    ExceptionTrace = ex.Message,
        ...
        public async Task<IActionResult> Delete(string id)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppTh),
                    Message = "Eliminar Parametro General",
                    ExceptionTrace = ex.Message,
                    LogCategoryParametre = Convert.ToString(LogCategoryParameter.Delete),
                    LogLevelShortName = Convert.ToString(LogLevelParameter.ERR),
                    UserName = "Usuario APP webappth"
