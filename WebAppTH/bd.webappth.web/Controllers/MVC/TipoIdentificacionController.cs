...
namespace bd.webappth.web.Controllers.MVC
{
    public class TipoIdentificacionController : Controller
    {
        ...
        public TipoIdentificacionController(IApiServicio apiServicio)
        {
        ...
        public async Task<IActionResult> Create(TipoIdentificacion tipoIdentificacion)
        {
            ...
            try
            {
                ...
                if (response.IsSuccess)
                {
                    ...
                    var responseLog = await GuardarLogService.SaveLogEntry(new LogEntryTranfer
                    {
                        ...
                        ExceptionTrace = null,
                        Message = "Se ha creado un tipo de identifiación",
                        UserName = "Usuario 1",
                        LogCategoryParametre = Convert.ToString(LogCategoryParameter.Create),
                        LogLevelShortName = Convert.ToString(LogLevelParameter.ADV),
                        EntityID = string.Format("{0} {1}", "Tipo de Enfermedad:", tipoIdentificacion.IdTipoIdentificacion),
                    });
            ...
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppTh),
                    Message = "Creando Tipo de Identificación",
                    ExceptionTrace = ex,
                    LogCategoryParametre = Convert.ToString(LogCategoryParameter.Create),
        ...
        public async Task<IActionResult> Index()
        {
            ...
            try
            {
                lista = await apiServicio.Listar<TipoIdentificacion>(new Uri(WebApp.BaseAddress)
                                                                    , "/api/TipoIdentificacion/ListarTipoIdentificacion");
                return View(lista);
            }
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppTh),
                    Message = "Listando tipos de identificaciones",
                    ExceptionTrace = ex,
        ...
        public async Task<IActionResult> Delete(string id)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppTh),
                    Message = "Eliminar Tipo de Identificación",
                    ExceptionTrace = ex,
                    LogCategoryParametre = Convert.ToString(LogCategoryParameter.Delete),
                    LogLevelShortName = Convert.ToString(LogLevelParameter.ERR),
                    UserName = "Usuario APP webappth"
