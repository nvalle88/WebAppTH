...
namespace bd.webappth.web.Controllers.MVC
{
    public class TipoMovimientoInternoController : Controller
    {
        ...
        public TipoMovimientoInternoController(IApiServicio apiServicio)
        {
        ...
        public async Task<IActionResult> Create(TipoMovimientoInterno tipoMovimientoInterno)
        {
            ...
            try
            {
                response = await apiServicio.InsertarAsync(tipoMovimientoInterno,
                                                             ...
                                                             "/api/TipoMovimientoInterno/InsertarTipoMovimientoInterno");
                if (response.IsSuccess)
                {
                    ...
                    var responseLog = await GuardarLogService.SaveLogEntry(new LogEntryTranfer
                    {
                        ...
                        EntityID = string.Format("{0} {1}", "Tipo de Enfermedad:", tipoMovimientoInterno.IdTipoMovimientoInterno),
                    });
            ...
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppTh),
                    Message = "Creando Tipo de Movimiento Interno",
                    ExceptionTrace = ex,
                    LogCategoryParametre = Convert.ToString(LogCategoryParameter.Create),
        ...
        public async Task<IActionResult> Index()
        {
            ...
            try
            {
                lista = await apiServicio.Listar<TipoMovimientoInterno>(new Uri(WebApp.BaseAddress)
                                                                    , "/api/TipoMovimientoInterno/ListarTipoMovimientoInterno");
                return View(lista);
            }
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppTh),
                    Message = "Listando tipos de movimientos internos",
                    ExceptionTrace = ex,
        ...
        public async Task<IActionResult> Delete(string id)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppTh),
                    Message = "Eliminar Tipo de Movimiento Interno",
                    ExceptionTrace = ex,
                    LogCategoryParametre = Convert.ToString(LogCategoryParameter.Delete),
                    LogLevelShortName = Convert.ToString(LogLevelParameter.ERR),
                    UserName = "Usuario APP webappth"
