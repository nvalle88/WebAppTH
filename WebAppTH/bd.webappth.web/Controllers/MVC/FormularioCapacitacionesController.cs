...
namespace bd.webappth.web.Controllers.MVC
{
    public class FormularioCapacitacionesController : Controller
    {
        ...
        public FormularioCapacitacionesController(IApiServicio apiServicio)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var lista = new List<FormularioCapacitacion>();
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppTh),
                    Message = "Listando formulario capacitaciones",
                    ExceptionTrace = ex.Message,
        ...
        public async Task<IActionResult> Delete(string id)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppTh),
                    Message = "Eliminar Formulario Capacitación",
                    ExceptionTrace = ex.Message,
                    LogCategoryParametre = Convert.ToString(LogCategoryParameter.Delete),
                    LogLevelShortName = Convert.ToString(LogLevelParameter.ERR),
                    UserName = "Usuario APP webappth"
