...
namespace bd.webappth.web.Controllers.MVC
{
    public class TiposIdentificacionController : Controller
    {
        ...
        public TiposIdentificacionController(IApiServicio apiServicio)
        {
        ...
        public async Task<IActionResult> Edit(string id)
        {
            try
            {
                if (!string.IsNullOrEmpty(id))
                {
                    ...
                    respuesta.Resultado = JsonConvert.DeserializeObject<TipoIdentificacion>(respuesta.Resultado.ToString());
        ...
        public async Task<IActionResult> Index()
        {
            ...
            try
            {
                lista = await apiServicio.Listar<TipoIdentificacion>(new Uri(WebApp.BaseAddress)
                                                                    , "api/TiposIdentificacion/ListarTiposIdentificacion");
                return View(lista);
            }
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppTh),
                    Message = "Listando un tipo de identificación",
                    ExceptionTrace = ex,
        ...
        public async Task<IActionResult> Delete(string id)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppTh),
                    Message = "Eliminar un tipo de identificación",
                    ExceptionTrace = ex,
                    LogCategoryParametre = Convert.ToString(LogCategoryParameter.Delete),
                    LogLevelShortName = Convert.ToString(LogLevelParameter.ERR),
                    UserName = "Usuario APP webappth"
