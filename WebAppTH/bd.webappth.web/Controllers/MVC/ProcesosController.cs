...
namespace bd.webappth.web.Controllers.MVC
{
    public class ProcesosController : Controller
    {
        ...
        public ProcesosController(IApiServicio apiServicio)
        {
            ...
            try
            {
                ...
                if (response.IsSuccess)
                {
                    ...
                    var responseLog = await GuardarLogService.SaveLogEntry(new LogEntryTranfer
                    {
                        ...
                        ExceptionTrace = null,
                        Message = "Se ha creado un Proceso",
                        UserName = "Usuario 1",
                        LogCategoryParametre = Convert.ToString(LogCategoryParameter.Create),
                        LogLevelShortName = Convert.ToString(LogLevelParameter.ADV),
                        EntityID = string.Format("{0} {1}", "Proceso:", Proceso.IdProceso),
                    });
        ...
        public async Task<IActionResult> Edit(string id)
        {
            try
            {
                if (!string.IsNullOrEmpty(id))
                {
                    ...
                    respuesta.Resultado = JsonConvert.DeserializeObject<Proceso>(respuesta.Resultado.ToString());
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, Proceso Proceso)
        {
            Response response = new Response();
            try
            {
